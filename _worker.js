export default {
  ...
  <html lang="zh-CN">
    ...
    <body class="p-4 md:p-8 pb-24 antialiased selection:bg-orange-100 selection:text-orange-600">
      ...
      <script type="text/babel" data-presets="react">
        ...
        const Sparkline = ({ data, color, width = 100, height = 30 }) => {
            ...
            const fillColor = color === 'green' ? 'rgba(16, 185, 129, 0.1)' : (color === 'yellow' ? 'rgba(245, 158, 11, 0.1)' : 'rgba(244, 63, 94, 0.1)');
                 ...
                 <header className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4 animate-slide-up">
                     ...
                     <div className="glass-card px-4 py-2 rounded-full flex items-center gap-4 text-xs font-mono text-gray-600 shadow-sm">
                         <div className="flex items-center gap-1.5">
                             ...
                             <span>Protocol: {window.CF_DATA.http}</span>
                         </div>
                         <div className="w-px h-3 bg-gray-300"></div>
                         <div>TLS: {window.CF_DATA.tls}</div>
                         {conn && (
                             <>
                                <div className="w-px h-3 bg-gray-300"></div>
